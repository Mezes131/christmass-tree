      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="section-description">
            An interactive 3D Christmas tree experience built with React and Three.js. 
            Customize lights, decorations, and snow effects in real-time. 
            Explore the magic of WebGL rendering and 3D interactions.
          </p>
