          ...
          {activeTab === 'help' && (
            <div className="tab-panel">
              ...
              <div className="help-content">
                <h4>Navigation</h4>
                <ul>
                  <li><strong>Mouse Movement</strong> : Rotate, zoom and pan the 3D scene</li>
                  <li><strong>Fullscreen Mode</strong> : Click the expand button for an immersive experience</li>
                  <li><strong>Controls Tab</strong> : Adjust lights, snow, and decorations</li>
                  <li><strong>Side Panel</strong> : Toggle this panel to access controls, information, and help</li>
                </ul>
                
                <h4>Controls</h4>
                <ul>
                  <li><strong>Lighting</strong> : Toggle lights on/off and choose animation modes</li>
                  <li><strong>Snow</strong> : Enable snow effect and adjust parameters</li>
                  <li><strong>Decorations</strong> : Toggle gifts, stars, ground, and moon</li>
                </ul>
              </div>
            </div>
          )}
